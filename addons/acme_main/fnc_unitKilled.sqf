...
#include "script_component.hpp"
	...
	private ["_enemykills","_civkills","_friendlykills","_sideKilled","_sideKiller","_suicides","_deaths","_killedtype","_killerweapon","_killertype","_distance","_pos","_datetime","_factionKiller","_factionKilled"];
