...
_list = switch (MISSIONTYPE_PO) do {
	...
	// Mix Easy
	case 4: {["CAP_target","CAP_town","CAP_vehicle","SAD_cache","SAD_nuke","SAD_camp","SAD_chemical","SAD_depot","SAD_radar","CRB_convoy","SAD_scud","SAD_tower","SAR_pilot","SAD_bombcar"]};
	// Mix Hard
