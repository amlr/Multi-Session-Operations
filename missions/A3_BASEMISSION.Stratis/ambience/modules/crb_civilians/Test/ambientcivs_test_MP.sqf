private ["_start","_player1","_player2","_groups","_grp","_flag","_players"];

if(!isServer) exitWith {};
if(!isMultiplayer || isDedicated) exitWith {["Init","Hosted Multi Player Test"] call fn_fail;};

format["Ambient Civilians Test - Hosted Multiplayer Player (%1 allMissionObjects)", count allMissionObjects ""] call fn_log;
...
while{{local _x} count allUnits != 1 || _flag} do {
