if(mps_ace_enabled) then {
	...
	_w = _w +  ["Binocular","NVGoggles","ItemCompass","ItemGPS","ItemMap","ItemRadio","ItemWatch","hgun_Rook40_F","hgun_Rook40_snds_F","FirstAidKit","H_HelmetB_light","H_HelmetB_paint","H_HelmetO_ocamo","H_MilCap_mcamo","H_PilotHelmetHeli_B","acc_flashlight","acc_pointer_IR","muzzle_snds_B","muzzle_snds_H","muzzle_snds_H_MG","muzzle_snds_L","optic_Aco","optic_ACO_grn","optic_Arco","optic_Hamr","optic_Holosight","U_B_CombatUniform_mcam","U_B_CombatUniform_mcam_tshirt","U_B_CombatUniform_mcam_vest","U_B_HeliPilotCoveralls","U_B_Wetsuit","V_BandollierB_cbr","V_BandollierB_khk","V_BandollierB_rgr","V_Chestrig_khk","V_ChestrigB_rgr","V_HarnessO_brn","V_HarnessOGL_brn","V_PlateCarrier1_cbr","V_PlateCarrier1_rgr","V_PlateCarrier2_rgr","V_PlateCarrierGL_rgr","V_Rangemaster_belt","V_RebreatherB","V_TacVest_brn","V_TacVest_khk","V_TacVest_oli"];

	_list = _list + [
		["PRIVATE", "ALL",	["arifle_MX_ACOg_point_grip_F"] ],
		["PRIVATE", "SOLDIER",	["arifle_MX_ACOg_point_grip_F"] ],
		["PRIVATE", "AT",	["arifle_MX_ACOg_point_grip_F"] ],
		["PRIVATE", "SNIPER",	["arifle_MX_ACOg_point_grip_F"] ],
		["PRIVATE", "MG",	["arifle_MX_ACOg_point_grip_F"] ],

		["CORPORAL", "ALL",	["arifle_MX_ACOg_point_grip_F"] ],
		["CORPORAL", "SOLDIER",	["arifle_MX_ACOg_point_grip_F"] ],
		["CORPORAL", "AT",	["arifle_MX_ACOg_point_grip_F"] ],
		["CORPORAL", "SNIPER",	["arifle_MX_ACOg_point_grip_F"] ],
		["CORPORAL", "MG",	["arifle_MX_ACOg_point_grip_F"] ],

		["SERGEANT", "ALL",	["arifle_MX_ACOg_point_grip_F"] ],
		["SERGEANT", "SOLDIER",	["arifle_MX_ACOg_point_grip_F"] ],
		["SERGEANT", "AT",	["arifle_MX_ACOg_point_grip_F"] ],
		["SERGEANT", "SNIPER",	[] ],
		["SERGEANT", "MG",	["arifle_MX_ACOg_point_grip_F"] ],

		["LIEUTENANT", "ALL",	["arifle_MX_ACOg_point_grip_F"] ],
		["LIEUTENANT", "SOLDIER",["arifle_MX_ACOg_point_grip_F"] ],
		["LIEUTENANT", "AT",	["arifle_MX_ACOg_point_grip_F"] ],
		["LIEUTENANT", "SNIPER",["arifle_MX_ACOg_point_grip_F"] ],
		["LIEUTENANT", "MG",	["arifle_MX_ACOg_point_grip_F"] ],

		["CAPTAIN", "ALL",	["arifle_MX_ACOg_point_grip_F"] ],
		["CAPTAIN", "SOLDIER",	[] ],
		["CAPTAIN", "AT",	[] ],
		["CAPTAIN", "SNIPER",	[] ],
		["CAPTAIN", "MG",	["arifle_MX_ACOg_point_grip_F"] ],

		["MAJOR",   "ALL",	["arifle_MX_ACOg_point_grip_F"] ],
		["MAJOR",   "SOLDIER",	[] ],
		["MAJOR",   "AT",	[] ],
		["MAJOR",   "SNIPER",	[] ],
		["MAJOR",   "MG",	["arifle_MX_ACOg_point_grip_F"] ],

		["COLONEL", "ALL",	["arifle_MX_ACOg_point_grip_F"] ],
		["COLONEL", "SOLDIER",	["arifle_MX_ACOg_point_grip_F"] ],
		["COLONEL", "AT",	[] ],
		["COLONEL", "SNIPER",	[] ],
		["COLONEL", "MG",	[] ]
	];
