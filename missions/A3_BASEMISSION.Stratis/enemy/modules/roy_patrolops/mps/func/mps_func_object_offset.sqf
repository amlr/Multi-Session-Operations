...
private["_obj","_veh","_range","_select"];
	...
	if(_obj isKindof "Land_CargoBox_V1_F")	then { _range = [ [0,-1.9,1], [0,-0.5,1], [0,-0.8,1], [0,-1.8,1] ] };
	...
	if(_obj isKindof "Land_CargoBox_V1_F")	then { _range = [ [0,-1.9,1], [0,-0.5,1], [0,-0.8,1], [0,-1.8,1] ] };
	if(_obj isKindof "Land_CargoBox_V1_F")	then { _range = [ [0,-1.9,1], [0,-0.5,1], [0,-1.8,1], [0,-1.8,1] ] };
