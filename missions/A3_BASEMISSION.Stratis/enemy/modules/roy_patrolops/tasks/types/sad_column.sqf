...
/*--------------------CREATE TARGET-----------------------------------*/
	...
	_car_type = (mps_opfor_armor) call mps_getRandomElement;
...
/*--------------------CREATE TASK OBJECTIVE---------------------------------*/
	...
	[ format["TASK%1",_taskid],
		...
		format["An armoured coloumn is patroling near %1. Locate and ambush the coloumn, disabling any vehicles.", text _location],
		(SIDE_A select 0),
