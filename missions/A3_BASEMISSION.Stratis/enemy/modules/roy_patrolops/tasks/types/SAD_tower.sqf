...
/*--------------------CREATE TARGET-----------------------------------*/
	...
	_tower = "Land_TTowerBig_1_F" createVehicle _position;
...
/*--------------------CREATE ENEMY AT LOCATION------------------------*/
	...
	for "_i" from 1 to 2 do { [_position] call CREATE_OPFOR_STATIC; };
...
/*--------------------CREATE TASK OBJECTIVE---------------------------------*/
	...
	[format["TASK%1",_taskid],
		...
		format["Enemy have a setup a comms relay somewhere in %1 which is relaying key intel on our troops positions to the enemy HQ. Locate and destroy it using C4.<br/><br/>Hostile insurgent and government troops patrolling random towns will be the key. <br/>Gather Intel from the enemies located in towns to narrow down the cache location.",worldname],
		true,
		[],
		"created"
	] call mps_tasks_add;
