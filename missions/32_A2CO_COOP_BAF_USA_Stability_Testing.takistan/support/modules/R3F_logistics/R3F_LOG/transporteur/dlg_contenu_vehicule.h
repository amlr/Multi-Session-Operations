...
class R3F_LOG_dlg_contenu_vehicule
{
	...
	class R3F_LOG_dlg_CV_liste_contenu : R3F_LOG_dlg_CV_liste
	{
		...
		x = 0.26; w = 0.45;
		y = 0.22; h = 0.44;
		onLBDblClick = "execVM ""support\modules\R3F_logistics\R3F_LOG\transporteur\decharger.sqf"";";
	};
	...
	class R3F_LOG_dlg_CV_btn_decharger : R3F_LOG_dlg_CV_btn
	{
		...
		sizeEx = 0.02;
		text = "";
		action = "execVM ""support\modules\R3F_logistics\R3F_LOG\transporteur\decharger.sqf"";";
	};
