...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`arma`@`localhost`*/ /*!50003 PROCEDURE `UpdatePlayerACE`(IN tawb VARCHAR(1000), IN tarc VARCHAR(45), IN taw VARCHAR(1000), IN tarm VARCHAR(1000), IN tpid varchar(45), IN tna VARCHAR(255), IN tmid INTEGER(11))
BEGIN
...
-- Dump completed on 2012-10-20 10:53:33
