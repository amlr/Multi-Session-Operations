...
CRB_fnc_RecruitMember = {
	CRBPROFILERSTART("CRB Terrorists recruitMember")
        ...
        if (_debug) then {
                ...
                _tcrm = [_t, _recpos, "Icon", [1,1], "TEXT:", _t, "TYPE:", "mil_dot", "COLOR:", "ColorBlue", "GLOBAL"] call CBA_fnc_createMarker;
        };
...
CRB_fnc_SplitCell = {
	CRBPROFILERSTART("CRB Terrorists splitCell")
        ...
        if (_debug) then {
                ...
                hint _str;
                diag_log _str;
                _tcrm = [_t, position _newveh, "Icon", [1,1], "TEXT:", _t, "TYPE:", "mil_dot", "COLOR:", "ColorYellow", "GLOBAL"] call CBA_fnc_createMarker;
        };
...
CRB_fnc_SpawnNewCell = {
	CRBPROFILERSTART("CRB Terrorists spawnNewCell")
        ...
        if (_debug) then {
                ...
                _tcsm = [_t, _spawn, "Icon", [1,1], "TEXT:", _t, "TYPE:", "mil_dot", "COLOR:", "ColorGreen", "GLOBAL"] call CBA_fnc_createMarker;
        };
        ...
        if (_debug) then {
                ...
                _tcdm = [_t, _pos, "Icon", [1,1], "TEXT:", _t, "TYPE:", "mil_dot", "COLOR:", "ColorRed", "GLOBAL"] call CBA_fnc_createMarker;
        };
