...
Example:
	[this, this, 300, "MOVE", "AWARE", "YELLOW", "FULL", "STAG COLUMN", "this spawn RMM_fnc_searchNearby", [3,6,9]]
Returns:
	Waypoint
Author:
	Rommel
...
_position = (_this select 1) call RMM_fnc_getpos;
