...
if (!(isNull player)) then 
	...
	gc_script_pack_cow_client_object_manager = execVM "modules\gc_pack_cow\client_object_manager.sqf";
	gc_script_pack_cow_client_action_manager = execVM "modules\gc_pack_cow\action_manager.sqf";
...
if (isServer) then 
	...
	gc_script_pack_cow_client_move_manager = execVM "modules\gc_pack_cow\cow_move_manager.sqf";
	gc_script_pack_cow_client_ai_manager = execVM "modules\gc_pack_cow\cow_ai_manager.sqf";
	};