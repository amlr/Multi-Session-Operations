...
[] call
{
	...
	call compile preprocessFile format ["modules\R3F_logistics\%1_strings_lang.sqf", R3F_ARTY_AND_LOG_CFG_langage];
	...
	{
		execVM "modules\R3F_logistics\surveiller_nouveaux_objets.sqf";
	}
	// Version allégée pour le serveur dédié
	else
	{
		execVM "modules\R3F_logistics\surveiller_nouveaux_objets_dedie.sqf";
	};
};