...
[0,_unit,{_this switchmove "ainjppnemstpsnonwrfldb_still"}] call CBA_fnc_ExMP;
...
//orientation
[0,_unit,{_this setdir 180}] call CBA_fnc_ExMP;
...
[0,_unit,{_this playaction "agonystart"}] call CBA_fnc_ExMP;