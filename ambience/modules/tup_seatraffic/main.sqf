...
private ["_debug","_sealandings","_center","_seadest","_destinations","_t","_m","_mapsize","_center"];
...
for "_j" from 0 to (_destinations-1) do {
    ...
    [_j, _seadest, _debug] spawn {
        ...
        while{true} do {
				...
				_seaportside =  [_currentseadest, 1000, format["%1 %2",_destination,_j],_debug] call mso_core_fnc_getDominantSide;
