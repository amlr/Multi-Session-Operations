...
_placing = {_object getvariable "RMM_logistics_placing"};
...
_action = _unit addaction [localize "dragger.sqf0","functions\client\fn_actionargument.sqf",[_object,{_this setvariable ["RMM_logistics_placing",false]}, true]];
_object setvariable ["RMM_logistics_placing",true,true];
...
_object setvariable ["RMM_logistics_placing",nil,true];