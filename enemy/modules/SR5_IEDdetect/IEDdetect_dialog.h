...
class IEDdetect_injector {
  ...
  class controls {
    class IEDdetect_tool: RscPicture {
      ...
      text = "enemy\modules\SR5_IEDdetect\screens\IEDdetect_09.paa";
    };
    ...
    class IEDdetect_injectP : RscPicture {
      ...
      text = "enemy\modules\SR5_IEDdetect\screens\IEDdetect_injectbutton.paa";
      action = "";
    };
    class IEDdetect_injectB : RscButtonTextOnly {
      ...
      text = "";
      action = "";
      onMouseButtonDown = "_dummy = [_this, ""MouseButtonDown"", [653], ""2""] execVM ""enemy\modules\SR5_IEDdetect\IEDdetect_injection.sqf"";";
      onMouseButtonUp = "";
      onMouseButtonDblClick = "_dummy = [_this, ""MouseButtonDown"",  [653], ""2""] execVM ""enemy\modules\SR5_IEDdetect\IEDdetect_injection.sqf"";";
      onMouseEnter = "";
      onMouseExit = "";
      onSetFocus = "";
      onKillFocus = "";
