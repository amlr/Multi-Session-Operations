...
while {alive _detector} do {
  ...
  if !(_detector in reezo_IEDdetect_EODs) then {
    reezo_IEDdetect_EODs = reezo_IEDdetect_EODs + [_detector];
    publicVariable "reezo_IEDdetect_EODs";
  };
      ...
      for [{_y = 0},{_y < _nearCount},{_y = _y + 1}] do {
        ...
        // CASE 2. REAL IED DETECTED
          if ((_near select _y) in reezo_IED_detector_objects && reezo_IEDdetect_busy == 0 && alive _detector) then {
            ...
            _action_reezo_IEDdetect_manualDefuse = reezo_IEDdetect_activeIED addAction ['<t color="#FF9800">'+"Defuse Bomb"+'</t>', "enemy\modules\SR5_IEDdetect\IEDdetect_manualDefuse.sqf", [], 0, false, true, "",""];
            ...
            if (reezo_IEDdetect_activeIED in reezo_IEDdetect_attachedIEDs) then {
              ...
              for [{_h= 0},{_h < (count _nearhosts)},{_h = _h + 1}] do {
                ...
                if (_thisHost in reezo_IEDdetect_hostIEDs) then {
                  _action_reezo_IEDdetect_detach = _thisHost addAction ['<t color="#FF3300">'+"Detach IED"+'</t>', "enemy\modules\SR5_IEDdetect\IEDdetect_detach.sqf", [reezo_IEDdetect_activeIED], 0, false, true, "",""];
                };
              };
            };
            ...
            if (_rnd < _skill) then {
              ...
              _action_reezo_IEDdetect_remoteDet = reezo_IEDdetect_activeEOD addAction ['<t color="#FF9800">'+"Remotely Detonate Bomb"+'</t>', "enemy\modules\SR5_IEDdetect\IEDdetect_remoteDet.sqf", [reezo_IEDdetect_activeIED], 0, false, true, "",""];
            };
...
nul0 = [player,(reezo_IEDdetect_detector_respawn select 1),(reezo_IEDdetect_detector_respawn select 2),(reezo_IEDdetect_detector_respawn select 3),(reezo_IEDdetect_detector_respawn select 4)] execVM "enemy\modules\SR5_IEDdetect\IEDdetect.sqf";  
