        ...
        // CASE 2. REAL IED DETECTED
          if ((_near select _y) in reezo_IED_detector_objects && _detector == driver _vehicle) then {
            ...
            if (_rnd < _skill) then {
              ...
              _action_reezo_IEDdetect_remoteDet = _vehicle addAction ['<t color="#FF9800">'+"Remotely Detonate Bomb"+'</t>', "enemy\modules\SR5_IEDdetect\IEDdetect_remoteDet.sqf", [reezo_IEDdetect_activeIED], 0, false, true, "",""];
            };
