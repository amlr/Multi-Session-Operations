...
//nul0 = [_detector,_range,_interval,_skill,_fakeRatio] execVM "enemy\modules\SR5_IEDdetect\IEDdetect_respawn_detector.sqf";
nul0 = [_detector,_range,_interval,_skill,_fakeRatio] execVM "enemy\modules\SR5_IEDdetect\IEDdetect.sqf";
