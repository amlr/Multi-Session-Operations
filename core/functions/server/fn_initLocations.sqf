...
switch toLower(worldName) do {		
        ...
        case "zargabad": {
                ...
                {(createVehicle ["HeliHCivil", (_x select 0), [],0,'NONE']) setDir (_x select 1);} foreach [[[3534.1, 3939.4], 270],[[4568,4124], 110]];
        ...
        case "takistan": {
                ...
                {(createVehicle ["HeliHCivil", (_x select 0), [],0,'NONE']) setDir (_x select 1);} foreach [[[8263,1800.54], 150.567],[[8222.98,1776.7,0.0101013],150.358],[[8180.42,1752.3,0.0100098],151.828],[[6046.42,10470.4,0.0102081],112.581]];
                {_twn = (group bis_functions_mainscope) createUnit ["LOGIC", (_x select 0), [], 0, "NONE"]; _twn setVariable ["name", (_x select 1)];[[_twn]] call BIS_fnc_locations;} foreach [
