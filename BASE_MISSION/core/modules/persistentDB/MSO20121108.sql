...
CREATE TABLE `locations` (
  ...
  PRIMARY KEY (`id`),
  KEY `mid` (`mid`)
) ENGINE=InnoDB AUTO_INCREMENT=192627 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `landvehicles` (
  ...
  PRIMARY KEY (`id`,`dam`),
  KEY `mid` (`mid`)
) ENGINE=InnoDB AUTO_INCREMENT=49387 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `players` (
  ...
  `awo` varchar(1000) DEFAULT '' COMMENT 'ACE Wounds',
...
CREATE TABLE `objects` (
  ...
  PRIMARY KEY (`id`),
  KEY `mid` (`mid`)
) ENGINE=InnoDB AUTO_INCREMENT=109822 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`arma`@`localhost`*/ /*!50003 PROCEDURE `InsertAARs`(IN tsitrep VARCHAR(1000), IN ttyp VARCHAR(45), IN tmid INTEGER(11), IN tintid INTEGER(11))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`arma`@`localhost`*/ /*!50003 PROCEDURE `UpdatePlayerACE`(IN tawb VARCHAR(1000), IN tarc VARCHAR(45), IN taw VARCHAR(1000), IN tarm VARCHAR(1000), IN tawo VARCHAR(1000), IN tpid varchar(45), IN tna VARCHAR(255), IN tmid INTEGER(11))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`arma`@`localhost`*/ /*!50003 PROCEDURE `UpdatePlayerWeapons`(IN twea VARCHAR(1000), IN tmag VARCHAR(1000), IN trck VARCHAR(45), IN trwe VARCHAR(1000), IN trma VARCHAR(1000), IN tpid varchar(45), IN tna VARCHAR(255), IN tmid INTEGER(11))
BEGIN
