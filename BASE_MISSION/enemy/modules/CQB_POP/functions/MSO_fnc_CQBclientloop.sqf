		...
		while {true} do {
                ...
                _clearcount = 0;
        		{
                    ...
                    if (((_x select 0) distance player < 800) && (((position player) select 2) < 5) && (({(local _x) && ((faction _x) in MSO_FACTIONS)} count allunits) < CQBaicap)) then {
                        ...
                        if (((_x select 0) distance player < 800) && (_activenow < 3) && _strategic) then {
                        ...
                        if (((_x select 0) distance player < 500) && ((_x select 0) distance player > 100) && (_activenow < 3) && _regular) then {
                        	if ((isnil "_suspend") && (isnil "_clear")) then {
                                _activenow = _activenow + 1;
