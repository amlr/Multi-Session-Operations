...
If (_addobjects) then {
	...
	_spottype = ["Land_Misc_Garb_Heap_EP1","Land_Misc_Rubble_EP1","Garbage_container","Land_ruin_wall","Land_ruin_wall_EP1","Land_ruin_wall_PMC","Land_ruin_rubble","Land_ruin_rubble_PMC","Land_A_Mosque_big_wall_gate_EP1","Land_Wall_L1_gate_EP1","Land_Wall_Gate_Ind1_L","Land_A_CityGate1_EP1","Land_Wall_CGry_5_D","Land_wall_indvar1_5_d","Land_wall_indfnc_3_d","Land_wall_indcnc_4_d","Land_wall_fenw_7_d","MAP_Wall_Stone"]; 
	{
		_goodspots = _goodspots + [position _x];
