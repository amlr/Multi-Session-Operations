...
//		Unit (leader of group):	null = [this,"triggername","SPAWNTYPE",LIVES,DELAY] execVM "WICT\sandbox\murk_spawn.sqf"; 
//		
...
_bodyRemove = 60;
waitUntil {!isNil "WICT_removeBody"};
_bodyRemove = if (_countThis >= 7) then { _this select 6; } else { WICT_removeBody }; // Optional
