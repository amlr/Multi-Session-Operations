...
while { damage _cont1 < 1 && damage _cont2 < 1 && count nearestObjects[_position,["Land_Misc_Cargo1E_EP1","Misc_Cargo1B_military"],30] < 2 } do { sleep 5 };

if( damage _cont1 >= 1 || damage _cont2 >= 1) then {
