...
Examples:
(begin example)
	[ _module, [ [key,value],[key,value],[key,value] ] ] call MSO_fnc_readData;
(end)
...
if (_debug) then {
    format["ReadData - Len:%1 Params:(%3)  Type:%2", [_params] call CBA_fnc_strLen, _params, typeName _params] call MSO_fnc_logger;
};
